...
app.post("/upload", upload.array("files", 10), async (req, res) => {
  ...
  try {
    ...
    //     });
    //     const vectorStore = await Chroma.fromDocuments(splitDocs, openaiEmbeddings,{
    //       collectionName: "a-test-collection",
    //       url: "http://localhost:8000", // Optional, will default to this value
    //       collectionMetadata: {
    //       "hnsw:space": "cosine",
    //       },
    //       persistdirectory: "D:\Nodejs\node_langchain_app\documents", // Optional, will default to this value
    //      }); // Optional, can be used to specify the distance method);
    ...
    if (file.mimetype === 'application/pdf') {
      ...
      // const filePath = `${userId}/${uploadId}/${Date.now()}-${
      //   file.originalname
      // }`;
      // const uploadParams = {
      //   Bucket: bucketName,
